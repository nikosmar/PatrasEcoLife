! function (t) {
    ...
    function i(t, e, r) {
        if (null !== t)
            for (var n, a, o, s, l, h, c, u, p = 0, f = 0, d = t.type, g = "FeatureCollection" === d, _ = "Feature" === d, m = g ? t.features.length : 1, y = 0; y < m; y++) {
                    ...
                    if (null !== (s = u ? c.geometries[v] : c)) {
                        ...
                        switch (p = !r || "Polygon" !== k && "MultiPolygon" !== k ? 0 : 1, k) {
                            case null:
                                break;
                            case "Point":
                                if (!1 === e(h, f, y, b, L)) return !1;
                                f++, b++;
                                break;
                            case "LineString":
                            case "MultiPoint":
                                for (n = 0; n < h.length; n++) {
                                    if (!1 === e(h[n], f, y, b, L)) return !1;
                                    f++, "MultiPoint" === k && b++
                                }
                                "LineString" === k && b++;
                                break;
                            ...
                            case "MultiPolygon":
                                for (n = 0; n < h.length; n++) {
                                    for (a = L = 0; a < h[n].length; a++) {
                                        for (o = 0; o < h[n][a].length - p; o++) {
                                            if (!1 === e(h[n][a][o], f, y, b, L)) return !1;
                                            f++
                                        }
                                        L++
                                    }
    ...
    function s(t, e) {
        var r, n, i, a, o, s, l, h, c, u, p = 0,
            f = "FeatureCollection" === t.type,
            d = "Feature" === t.type,
            g = f ? t.features.length : 1;
        for (r = 0; r < g; r++) {
            for (s = f ? t.features[r].geometry : d ? t.geometry : t, h = f ? t.features[r].properties : d ? t.properties : {}, c = f ? t.features[r].bbox : d ? t.bbox : void 0, u = f ? t.features[r].id : d ? t.id : void 0, o = (l = !!s && "GeometryCollection" === s.type) ? s.geometries.length : 1, i = 0; i < o; i++)
                if (null !== (a = l ? s.geometries[i] : s)) switch (a.type) {
                    ...
                    case "MultiLineString":
                    case "MultiPolygon":
                        if (!1 === e(a, p, h, c, u)) return !1;
                        break;
                    case "GeometryCollection":
                        for (n = 0; n < a.geometries.length; n++)
                            if (!1 === e(a.geometries[n], p, h, c, u)) return !1;
                        break;
                    default:
                        throw new Error("Unknown Geometry Type")
            ...
            if (t.geometry) {
                ...
                if ("Point" !== s && "MultiPoint" !== s) {
                    ...
                    return !1 !== i(t, (function (i, s, p, f, d) {
                        if (void 0 === l || h < r || c < f || u < d) return l = i, h = r, c = f, u = d, void(o = 0);
    ...
    function i(t, e, r, n, i, a, o, s) {
        ...
        return 0 == (l = (s - a) * (r - t) - (o - i) * (n - e)) ? null !== p.x && null !== p.y && p : (u = (r - t) * (h = e - a) - (n - e) * (c = t - i), h = ((o - i) * h - (s - a) * c) / l, c = u / l, p.x = t + h * (r - t), p.y = e + h * (n - e), 0 <= h && h <= 1 && (p.onLine1 = !0), 0 <= c && c <= 1 && (p.onLine2 = !0), !(!p.onLine1 || !p.onLine2) && [p.x, p.y])
    }
    ...
    e.default = function (t, e) {
        ...
        if ("LineString" === t.type && (t = i.feature(t)), "LineString" === e.type && (e = i.feature(e)), "Feature" === t.type && "Feature" === e.type && null !== t.geometry && null !== e.geometry && "LineString" === t.geometry.type && "LineString" === e.geometry.type && 2 === t.geometry.coordinates.length && 2 === e.geometry.coordinates.length) {
            var c = h(t, e);
            return c && n.push(c), i.featureCollection(n)
        }
        var u = l.default();
        return u.load(o.default(e)), s.featureEach(o.default(t), (function (t) {
            s.featureEach(u.search(t), (function (e) {
                var i = h(t, e);
                if (i) {
    ...
    ! function (t) {
        ...
        r.prototype.rotateLeft = function (t) {
            ...
            }(t, e, 0, n - 1, this._compare), this._root = function t(e, r, n, i, a) {
                var o = a - i;
                if (0 < o) {
                    ...
                    return l.left = t(l, r, n, i, s), l.right = t(l, r, n, s + 1, a), l
                }
                return null
            ...
            return this._size
        }, r.createTree = function (t, e, n, i, a) {
            return new r(n, a).load(t, e, i)
        }, Object.defineProperties(r.prototype, n);

        function i(t, e, r) {
            null === e ? (t.inOut = !1, t.otherInOut = !0) : (t.isSubject === e.isSubject ? (t.inOut = !e.inOut, t.otherInOut = e.otherInOut) : (t.inOut = !e.otherInOut, t.otherInOut = e.isVertical() ? !e.inOut : e.inOut), e && (t.prevInResult = !a(e, r) || e.isVertical() ? e.prevInResult : e)), t.inResult = a(t, r)
        }
        ...
        var o = function (t, e, r, n, i) {
            this.left = e, this.point = t, this.otherEvent = r, this.isSubject = n, this.type = i || 0, this.inOut = !1, this.otherInOut = !1, this.prevInResult = null, this.inResult = !1, this.resultInOut = !1, this.isExteriorRing = !0
        };
        ...
        function h(t, e) {
            ...
            return r[0] > n[0] ? 1 : r[0] < n[0] ? -1 : r[1] !== n[1] ? r[1] > n[1] ? 1 : -1 : function (t, e, r, n) {
                return t.left === e.left ? 0 === l(r, t.otherEvent.point, e.otherEvent.point) ? !t.isSubject && e.isSubject ? 1 : -1 : t.isBelow(e.otherEvent.point) ? -1 : 1 : t.left ? 1 : -1
            }(t, e, r)
        }

        function c(t, e, r) {
            var n = new o(e, !1, t, t.isSubject),
                i = new o(e, !0, t.otherEvent, t.isSubject);
            return s(t.point, t.otherEvent.point) && console.warn("what is that, a collapsed segment?", t), n.contourId = i.contourId = t.contourId, 0 < h(i, t.otherEvent) && (t.otherEvent.left = !0, i.left = !1), t.otherEvent.otherEvent = i, t.otherEvent = n, r.push(i), r.push(n), r
        }
        ...
        function f(t, e, r) {
            var n = function (t, e, r, n, i) {
                    ...
                    if (0 < c) {
                        ...
                        var g = u(l, a) / h;
                        return g < 0 || 1 < g ? null : 0 == d || 1 == d ? i ? null : [s(t, d, a)] : 0 == g || 1 == g ? i ? null : [s(r, g, o)] : [s(t, d, a)]
                    }
                    if (0 < (c = (h = u(l, a)) * h)) return null;
                    var _ = p(a, l) / f,
                        m = _ + p(a, o) / f,
                        y = Math.min(_, m),
                        v = Math.max(_, m);
                    return y <= 1 && 0 <= v ? 1 === y ? i ? null : [s(t, 0 < y ? y : 0, a)] : 0 === v ? i ? null : [s(t, v < 1 ? v : 1, a)] : i && 0 === y && 1 === v ? null : [s(t, 0 < y ? y : 0, a), s(t, v < 1 ? v : 1, a)] : null
                }(t.point, t.otherEvent.point, e.point, e.otherEvent.point),
                i = n ? n.length : 0;
            if (0 === i) return 0;
            if (1 === i && (s(t.point, e.point) || s(t.otherEvent.point, e.otherEvent.point))) return 0;
            if (2 === i && t.isSubject === e.isSubject) return 0;
            if (1 === i) return s(t.point, n[0]) || s(t.otherEvent.point, n[0]) || c(t, n[0], r), s(e.point, n[0]) || s(e.otherEvent.point, n[0]) || c(e, n[0], r), 1;
            var a = [],
                o = !1,
                l = !1;
            return s(t.point, e.point) ? o = !0 : 1 === h(t, e) ? a.push(e, t) : a.push(t, e), s(t.otherEvent.point, e.otherEvent.point) ? l = !0 : 1 === h(t.otherEvent, e.otherEvent) ? a.push(e.otherEvent, t.otherEvent) : a.push(t.otherEvent, e.otherEvent), o && l || o ? (e.type = 1, t.type = e.inOut === t.inOut ? 2 : 3, o && !l && c(a[1].otherEvent, a[0].point, r), 2) : (l ? c(a[0], a[1].point, r) : a[0] !== a[3].otherEvent ? (c(a[0], a[1].point, r), c(a[1], a[2].point, r)) : (c(a[0], a[1].point, r), c(a[3].otherEvent, a[2].point, r)), 3)
        }

        function d(t, e) {
            if (t === e) return 0;
            if (0 !== l(t.point, t.otherEvent.point, e.point) || 0 !== l(t.point, t.otherEvent.point, e.otherEvent.point)) return s(t.point, e.point) ? t.isBelow(e.otherEvent.point) ? -1 : 1 : t.point[0] === e.point[0] ? t.point[1] < e.point[1] ? -1 : 1 : 1 === h(t, e) ? e.isAbove(t.point) ? -1 : 1 : t.isBelow(e.point) ? -1 : 1;
            if (t.isSubject !== e.isSubject) return t.isSubject ? -1 : 1;
            var r = t.point,
                n = e.point;
            return r[0] === n[0] && r[1] === n[1] ? (r = t.otherEvent.point, n = e.otherEvent.point, r[0] === n[0] && r[1] === n[1] ? 0 : t.contourId > e.contourId ? 1 : -1) : 1 === h(t, e) ? 1 : -1
        }
        ...
        function y(t, e) {
            ...
            if (this.data = t || [], this.length = this.data.length, this.compare = e || v, 0 < this.length)
            ...
            _down: function (t) {
                for (var e = this.data, r = this.compare, n = this.length >> 1, i = e[t]; t < n;) {
                    var a = 1 + (t << 1),
                        o = a + 1,
                        s = e[a];
                    if (o < this.length && r(e[o], s) < 0 && (s = e[a = o]), 0 <= r(s, i)) break;
                    e[t] = s, t = a
                }
                e[t] = i
            }
        ...
        function M(t, e, r, n, i, a) {
            ...
            for (s = 0, l = t.length - 1; s < l; s++)
                if (c = t[s], u = t[s + 1], p = new o(c, !1, void 0, e), f = new o(u, !1, p, e), p.otherEvent = f, c[0] !== u[0] || c[1] !== u[1]) {
                    p.contourId = f.contourId = r, a || (p.isExteriorRing = !1, f.isExteriorRing = !1), 0 < h(p, f) ? f.left = !0 : p.left = !0;
                    var d = c[0],
                        g = c[1];
                    i[0] = L(i[0], d), i[1] = L(i[1], g), i[2] = b(i[2], d), i[3] = b(i[3], g), n.push(p), n.push(f)
                }
        }
        var w = [];
        ...
        function C(t, e, n) {
            ...
            var a = function (t, e, r) {
                var n = null;
                return t.length * e.length == 0 && (0 === r ? n = w : 2 === r ? n = t : 1 !== r && 3 !== r || (n = 0 === t.length ? e : t)), n
            }(t, e, n);
            if (a) return a === w ? null : a;
            var o = [1 / 0, 1 / 0, -1 / 0, -1 / 0],
                s = [1 / 0, 1 / 0, -1 / 0, -1 / 0],
                l = function (t, e, r, n, i) {
                    var a, o, s, l, c, u, p = new _(null, h);
                    for (s = 0, l = t.length; s < l; s++)
                        for (c = 0, u = (a = t[s]).length; c < u; c++)(o = 0 === c) && k++, M(a[c], !0, k, p, r, o);
                    for (s = 0, l = e.length; s < l; s++)
                        for (c = 0, u = (a = e[s]).length; c < u; c++) o = 0 === c, 2 === i && (o = !1), o && k++, M(a[c], !1, k, p, n, o);
                    return p
                }(t, e, o, s, n);
            return (a = function (t, e, r, n, i) {
                var a = null;
                return (r[0] > n[2] || n[0] > r[2] || r[1] > n[3] || n[1] > r[3]) && (0 === i ? a = w : 2 === i ? a = t : 1 !== i && 3 !== i || (a = t.concat(e))), a
            }(t, e, o, s, n)) ? a === w ? null : a : function (t, e) {
                var r, n, i, a = function (t) {
                        var e, r, n, i, a = [];
                        for (r = 0, n = t.length; r < n; r++)((e = t[r]).left && e.inResult || !e.left && e.otherEvent.inResult) && a.push(e);
                        for (var o = !1; !o;)
                            for (o = !0, r = 0, n = a.length; r < n; r++) r + 1 < n && 1 === h(a[r], a[r + 1]) && (i = a[r], a[r] = a[r + 1], a[r + 1] = i, o = !1);
                        for (r = 0, n = a.length; r < n; r++)(e = a[r]).pos = r;
                        for (r = 0, n = a.length; r < n; r++)(e = a[r]).left || (i = e.pos, e.pos = e.otherEvent.pos, e.otherEvent.pos = i);
                        return a
                    }(t),
                    o = {},
                    s = [];
                for (r = 0, n = a.length; r < n; r++)
                    if (!o[r]) {
                        ...
                        a[r].isExteriorRing ? 2 === e && !a[r].isSubject && 1 < s.length ? s[s.length - 1].push(l[0]) : s.push(l) : 2 !== e || a[r].isSubject || 0 !== s.length ? 0 === s.length ? s.push([
                            [l]
                        ]) : s[s.length - 1].push(l[0]) : s.push(l);
                        var c = s.length - 1,
                            u = r,
                            p = a[r].point;
                        for (l[0].push(p); r <= u;) i = a[u], o[u] = !0, i.left ? (i.resultInOut = !1, i.contourId = c) : (i.otherEvent.resultInOut = !0, i.otherEvent.contourId = c), o[u = i.pos] = !0, l[0].push(a[u].point), u = g(u, a, o, r);
                        i = a[u = -1 === u ? r : u], o[u] = o[i.pos] = !0, i.otherEvent.resultInOut = !0, i.otherEvent.contourId = c
                    }
                return s
            }(function (t, e, n, a, o, s) {
                for (var l, h, c, u = new r(d), p = [], g = Math.min(a[2], o[2]); 0 !== t.length;) {
                    var _ = t.pop();
                    if (p.push(_), 0 === s && _.point[0] > g || 2 === s && _.point[0] > a[2]) break;
                    if (_.left) {
                        h = l = u.insert(_), l = l !== (c = u.minNode()) ? u.prev(l) : null, h = u.next(h);
                        var m = l ? l.key : null;
                        if (i(_, m, s), h && 2 === f(_, h.key, t) && (i(_, m, s), i(_, h.key, s)), l && 2 === f(l.key, _, t)) {
                            var y = l;
                            i(m, (y = y !== c ? u.prev(y) : null) ? y.key : null, s), i(_, m, s)
                        }
                    } else _ = _.otherEvent, h = l = u.find(_), l && h && (l = l !== c ? u.prev(l) : null, h = u.next(h), u.remove(_), h && l && f(l.key, h.key, t))
                }
                return p
            }(l, 0, 0, o, s, n), n)
        }
        ...
        t.union = function (t, e) {
            ...
            return C(t, e, 0)
        }, t.operations = x, Object.defineProperty(t, "__esModule", {
            value: !0
        })
    }(e)
}, function (t, e, r) {
    ...
    function a(t) {
        ...
        if (t && 0 < t.length) {
            e += Math.abs(o(t[0]));
            for (var r = 1; r < t.length; r++) e -= Math.abs(o(t[r]))
        }
        return e
    }
    ...
    function o(t) {
        var e, r, n, a, o, l, h = 0,
            c = t.length;
        if (2 < c) {
            for (l = 0; l < c; l++) o = l === c - 2 ? (n = c - 2, a = c - 1, 0) : l === c - 1 ? (n = c - 1, a = 0, 1) : (a = (n = l) + 1, l + 2), e = t[n], r = t[a], h += (s(t[o][0]) - s(e[0])) * Math.sin(s(r[1]));
            h = h * i * i / 2
        }
        return h
    }
        ...
        return n.geomReduce(t, (function (t, e) {
            return t + function (t) {
                ...
                switch (t.type) {
                    ...
                    case "MultiPolygon":
                        for (e = 0; e < t.coordinates.length; e++) r += a(t.coordinates[e]);
                        return r;
                    case "Point":
                    case "MultiPoint":
                    case "LineString":
    ...
    t.exports = JSON.parse('{"a":"2.6.0"}')
}, function (t, e, r) {
    var n = r(62),
        i = r(119)((function (t, e, r) {
            n(t, e, r)
        }));
    t.exports = i
}, function (t) {
    ...
    e.default = function t(e, r, n) {
        ...
        if ("Polygon" === s.type && "Polygon" === l.type) {
            var h = o.intersection(s.coordinates, l.coordinates);
    ...
    t.exports = function t(e, r, c, u, p) {
        e !== r && a(r, (function (a, l) {
            if (p = p || new n, s(a)) o(e, r, l, c, t, u, p);
            else {
                var f = u ? u(h(e, l), a, l + "", e, r, p) : void 0;
    ...
    var n = r(31),
        ...
        _ = r(37),
        m = r(112);
    t.exports = function (t, e, r, y, v, b, L) {
        var k = _(t, r),
            M = _(e, r),
            w = L.get(M);
        if (w) n(t, r, w);
        else {
            var C = b ? b(k, M, r + "", t, e, L) : void 0,
                x = void 0 === C;
            if (x) {
                var S = h(M),
                    E = !S && u(M),
                    P = !S && !E && g(M);
                C = M, S || E || P ? C = h(k) ? k : c(k) ? o(k) : E ? i(M, !(x = !1)) : P ? a(M, !(x = !1)) : [] : d(M) || l(M) ? l(C = k) ? C = m(k) : f(k) && !p(k) || (C = s(M)) : x = !1
            }
            x && (L.set(M, C), v(C, M, y, b, L), L.delete(M)), n(t, r, C)
        }
    }
}, function (t, e, r) {
    (function (t) {
    ...
    t.exports = function (t, e, r, a) {
        ...
        for (var s = -1, l = e.length; ++s < l;) {
            ...
            void 0 === c && (c = t[h]), o ? i(r, h, c) : n(r, h, c)
        }
        return r
    }
}, function (t, e, r) {
    ...
    t.exports = function (t, e, r) {
        ...
        return u || ++h != c ? u : !!(c = null == t ? 0 : t.length) && s(c) && o(p, c) && (a(t) || i(t))
    }
}, function (t, e, r) {
    "use strict";
    Object.defineProperty(e, "__esModule", {
    ...
    i.prototype = {
        ...
        remove: function (t, e) {
            if (!t) return this;
            for (var r, n, i, o, s = this.data, l = this.toBBox(t), h = [], c = []; s || h.length;) {
                if (s || (s = h.pop(), n = h[h.length - 1], r = c.pop(), o = !0), s.leaf && -1 !== (i = a(t, s.children, e))) return s.children.splice(i, 1), h.push(s), this._condense(h), this;
                o || s.leaf || !f(s, l) ? n ? (r++, s = n.children[r], o = !1) : s = null : (h.push(s), c.push(r), r = 0, s = (n = s).children[0])
            }
            return this
        },
        toBBox: function (t) {
        ...
        _build: function (t, e, r, n) {
            ...
            var l, h, c, u, p = Math.ceil(a / s),
                f = p * Math.ceil(Math.sqrt(s));
            for (_(t, e, r, f, this.compareMinX), l = e; l <= r; l += f)
                for (_(t, l, c = Math.min(l + f - 1, r), p, this.compareMinY), h = l; h <= c; h += p) u = Math.min(h + p - 1, c), i.children.push(this._build(t, h, u, n - 1));
            return o(i, this.toBBox), i
        },
        _chooseSubtree: function (t, e, r, n) {
            for (var i, a, o, s, l, h, c, p, f, d; n.push(e), !e.leaf && n.length - 1 !== r;) {
                for (c = p = 1 / 0, i = 0, a = e.children.length; i < a; i++) l = u(o = e.children[i]), f = t, d = o, (h = (Math.max(d.maxX, f.maxX) - Math.min(d.minX, f.minX)) * (Math.max(d.maxY, f.maxY) - Math.min(d.minY, f.minY)) - l) < p ? (p = h, c = l < c ? l : c, s = o) : h === p && l < c && (c = l, s = o);
                e = s || e.children[0]
            }
            return e
        },
        ...
        _chooseSplitIndex: function (t, e, r) {
            var n, i, a, o, l, h, c, p, f, d, g, _, m, y;
            for (h = c = 1 / 0, n = e; n <= r - e; n++) f = i = s(t, 0, n, this.toBBox), d = a = s(t, n, r, this.toBBox), g = Math.max(f.minX, d.minX), _ = Math.max(f.minY, d.minY), m = Math.min(f.maxX, d.maxX), y = Math.min(f.maxY, d.maxY), o = Math.max(0, m - g) * Math.max(0, y - _), l = u(i) + u(a), o < h ? (h = o, p = n, c = l < c ? l : c) : o === h && l < c && (c = l, p = n);
            return p
        },
        ...
        _allDistMargin: function (t, e, r, n) {
            ...
            var i, a, o = this.toBBox,
                ...
                c = s(t, r - e, r, o),
                u = p(h) + p(c);
            for (i = e; i < r - e; i++) a = t.children[i], l(h, t.leaf ? o(a) : a), u += p(h);
            for (i = r - e - 1; e <= i; i--) a = t.children[i], l(c, t.leaf ? o(a) : a), u += p(c);
            return u
        },
                ...
                for (; i < a;) {
                    if (600 < a - i) {
                        var s = a - i + 1,
                            ...
                            h = Math.log(s),
                            c = .5 * Math.exp(2 * h / 3),
                            u = .5 * Math.sqrt(h * c * (s - c) / s) * (l - s / 2 < 0 ? -1 : 1);
                        e(r, n, Math.max(i, Math.floor(n - l * c / s + u)), Math.min(a, Math.floor(n + (s - l) * c / s + u)), o)
                    }
                    var p = r[n],
                        f = i,
                        d = a;
    ...
    function k(t) {
        ...
        return b()(_, e) || (e = "en"), y()(_[e], t)
    }

    function M(t, e, r) {
        for (var n, i, a, o = 6378137, s = 6356752.3142, l = 1 / 298.257223563, h = t.lng, c = t.lat, u = r, p = Math.PI, f = e * p / 180, d = Math.sin(f), g = Math.cos(f), _ = (1 - l) * Math.tan(c * p / 180), m = 1 / Math.sqrt(1 + _ * _), y = _ * m, v = Math.atan2(_, g), b = m * d, k = 1 - b * b, M = k * (o * o - s * s) / (s * s), w = 1 + M / 16384 * (4096 + M * (M * (320 - 175 * M) - 768)), C = M / 1024 * (256 + M * (M * (74 - 47 * M) - 128)), x = u / (s * w), S = 2 * Math.PI; 1e-12 < Math.abs(x - S);) n = Math.cos(2 * v + x), S = x, x = u / (s * w) + C * (i = Math.sin(x)) * (n + C / 4 * ((a = Math.cos(x)) * (2 * n * n - 1) - C / 6 * n * (4 * i * i - 3) * (4 * n * n - 3)));
        var E = y * i - m * a * g,
            P = Math.atan2(y * a + m * i * g, (1 - l) * Math.sqrt(b * b + E * E)),
            O = l / 16 * k * (4 + l * (4 - 3 * k)),
            B = h + 180 * (Math.atan2(i * d, m * a - y * i * g) - (1 - O) * l * b * (x + O * i * (n + O * a * (2 * n * n - 1)))) / p,
            D = 180 * P / p;
        return L.latLng(B, D)
    }

    function w(t, e, r, n) {
        for (var i, a, o = [], s = 0; s < r; s += 1) i = M(t, 360 * s / r + n, e), a = L.latLng(i.lng, i.lat), o.push(a);
        return o
    }
    var C = {
        ...
        findLayers: function (t) {
            ...
            return t.eachLayer((function (t) {
                (t instanceof L.Polyline || t instanceof L.Marker || t instanceof L.Circle || t instanceof L.CircleMarker) && e.push(t)
        ...
        circleToPolygon: function (t) {
            for (var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 60, r = w(t.getLatLng(), t.getRadius(), e, 0), n = [], i = 0; i < r.length; i += 1) {
                var a = [r[i].lat, r[i].lng];
                n.push(a)
            }
            return L.polygon(n, t.options)
        },
        createGeodesicPolygon: w,
        getTranslation: k
    };
    ...
    var P = C.findLayers,
        O = {
            ...
            enableGlobalEditMode: function (t) {
                ...
                this.Toolbar.toggleButton("editMode", !0), P(this.map).forEach((function (t) {
                    t.pm.enable(e)
                })), this.throttledReInitEdit || (this.throttledReInitEdit = L.Util.throttle(this.handleLayerAdditionInGlobalEditMode, 100, this)), this.map.on("layeradd", this.throttledReInitEdit, this), this.setGlobalEditStatus(!0)
            },
            disableGlobalEditMode: function () {
                P(this.map).forEach((function (t) {
                    t.pm.disable()
                })), this.map.off("layeroff", this.throttledReInitEdit, this), this.Toolbar.toggleButton("editMode", !1), this.setGlobalEditStatus(!1)
            },
            ...
            handleLayerAdditionInGlobalEditMode: function (t) {
                var e = t.layer;
                !e.pm || e._pmTempLayer || !this.globalEditModeEnabled() || e.pm.enable(S(S({}, this.globalOptions), {}, {
                    snappable: this._globalSnappingEnabled
                }))
            },
        ...
        j = {
            ...
            removeLayer: function (t) {
                var e = t.target;
                e._pmTempLayer || e.pm && e.pm.dragging() || (e.remove(), e.fire("pm:remove", {
                    layer: e
        ...
        N = L.Class.extend({
            ...
            setLang: function () {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "en",
                    ...
                    n = L.PM.activeLang;
                e && (_[t] = a()(_[r], e)), L.PM.activeLang = t, this.map.pm.Toolbar.reinit(), this.map.fire("pm:langchange", {
                    oldLang: n,
                    activeLang: t,
                    fallback: r,
                    translations: _[t]
        ...
        A = L.Control.extend({
            ...
            _makeButton: function (t) {
                var e = this,
                    ...
                    a = L.DomUtil.create("div", "leaflet-pm-actions-container ".concat(r), n),
                    o = t.actions,
                    s = {
                        cancel: {
                ...
                o.forEach((function (t) {
                    ...
                    var i = L.DomUtil.create("a", "leaflet-pm-action ".concat(r, " action-").concat(t), a);
                    i.innerHTML = n.text, n.onClick && L.DomEvent.addListener(i, "click", n.onClick, e), L.DomEvent.disableClickPropagation(i)
    ...
    var F = L.Class.extend({
            ...
            _defineButtons: function () {
                ...
                this._addButton("drawMarker", new L.Control.PMButton(e)), this._addButton("drawPolyline", new L.Control.PMButton(n)), this._addButton("drawRectangle", new L.Control.PMButton(o)), this._addButton("drawPolygon", new L.Control.PMButton(r)), this._addButton("drawCircle", new L.Control.PMButton(i)), this._addButton("drawCircleMarker", new L.Control.PMButton(a)), this._addButton("editMode", new L.Control.PMButton(s)), this._addButton("dragMode", new L.Control.PMButton(l)), this._addButton("cutPolygon", new L.Control.PMButton(h)), this._addButton("removalMode", new L.Control.PMButton(c))
            },
            _showHideButtons: function () {
                ...
                for (var r in !1 === this.options.drawControls && (e = e.concat(Object.keys(t).filter((function (e) {
                    ...
                    })))), t) this.options[r] && -1 === e.indexOf(r) && (t[r].setPosition(this.options.position), t[r].addTo(this.map))
            },
            copyDrawControl: function (t, e) {
                ...
                var i = this.map.pm.Draw.createNewDrawInstance(e.name, n),
                    a = this.buttons[n]._button;
                return e = Object.assign({}, a, e), {
                    drawInstance: i,
            ...
            createCustomControl: function (t) {
                ...
                t.onClick || (t.onClick = function () {}), t.afterClick || (t.afterClick = function () {}), !1 !== t.toggle && (t.toggle = !0), t.block && (t.block = t.block.toLowerCase()), t.block && "draw" !== t.block || (t.block = ""), -1 === t.className.indexOf("control-icon") && (t.className = "control-icon ".concat(t.className));
                var e = {
                    tool: t.block,
            ...
            changeActionsOfControl: function (t, e) {
                ...
                if (!this.buttons[n]) throw new TypeError("Button with this name not exists");
        ...
        U = {
            ...
            _handleSnapping: function (t) {
                ...
                if (void 0 === this._snapList && (this._createSnapList(), this._map.off("layeradd", r, this), this._map.on("layeradd", r, this)), this._snapList.length <= 0) return !1;
                var n, i = t.target,
                    a = this._calcClosestLayer(i.getLatLng(), this._snapList),
                    o = a.layer instanceof L.Marker || a.layer instanceof L.CircleMarker;
                n = o ? a.latlng : this._checkPrioritiySnapping(a);
                var s = this.options.snapDistance,
                    l = {
                        ...
                        layerInteractedWith: a.layer,
                        distance: a.distance
                    };
                if (l.marker.fire("pm:snapdrag", l), this._layer.fire("pm:snapdrag", l), a.distance < s) {
                    i.setLatLng(n), i._snapped = !0;
                    var h = this._snapLatLng || {},
                        c = n || {};
                    h.lat === c.lat && h.lng === c.lng || (e._snapLatLng = n, i.fire("pm:snap", l), e._layer.fire("pm:snap", l))
                } else this._snapLatLng && (this._unsnap(l), i._snapped = !1, l.marker.fire("pm:unsnap", l), this._layer.fire("pm:unsnap", l));
                return !0
            },
            _checkPrioritiySnapping: function (t) {
                ...
                if (this.options.snapMiddle) {
                    var c = C.calcMiddleLatLng(r, n, i),
                        u = this._getDistance(r, c, a);
                    u < o && u < s && (l = c, h = u)
                }
            ...
            _createSnapList: function () {
                ...
                n.off("pm:remove", this._handleSnapLayerRemoval, this), n.on("pm:remove", this._handleSnapLayerRemoval, this), n.eachLayer((function (t) {
                    if ((t instanceof L.Polyline || t instanceof L.Marker || t instanceof L.CircleMarker) && !0 !== t.options.snapIgnore) {
                        (t instanceof L.Circle || t instanceof L.CircleMarker) && t.pm._hiddenPolyCircle && e.push(t.pm._hiddenPolyCircle), e.push(t);
                        var n = L.polyline([], {
                            color: "red",
                            pmIgnore: !0
                        });
            ...
            _calcClosestLayer: function (t, e) {
                ...
                return e.forEach((function (e, i) {
                    if (!e._parentCopy || e._parentCopy !== r._layer) {
                        var a = r._calcLayerDistances(t, e);
                        r.debugIndicatorLines[i].setLatLngs([t, a.latlng]), (void 0 === n.distance || a.distance < n.distance) && ((n = a).layer = e)
                    }
                })), n
            },
                ...
                ! function t(e) {
                    e.forEach((function (o, h) {
                        if (Array.isArray(o)) t(o);
                            ...
                            var p = e[c];
                            if (p) {
                                var f = i._getDistanceToSegment(a, l, u, p);
                                (void 0 === n || f < n) && (n = f, r = [u, p])
                            }
                        }
                    }))
                }(h);
                var c = this._getClosestPointOnSegment(a, t, r[0], r[1]);
                return {
        ...
        H = L.Class.extend({
            ...
            _setGlobalDrawMode: function () {
                "Cut" === this._shape ? this._map.fire("pm:globalcutmodetoggled", {
            ...
            createNewDrawInstance: function (t, e) {
                ...
                return this[t] = new L.PM.Draw[r](this._map), this[t].toolbarButtonName = t, this.shapes.push(t), this[e] && this[t].setOptions(this[e].options), this[t].setOptions(this[t].options), this[t]
            },
    ...
    H.Marker = H.extend({
        ...
        enable: function (t) {
            ...
            L.Util.setOptions(this, t), this._enabled = !0, this._map.on("click", this._createMarker, this), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !0), this._hintMarker = L.marker([0, 0], this.options.markerStyle), this._hintMarker._pmTempLayer = !0, this._hintMarker.addTo(this._map), this.options.tooltips && this._hintMarker.bindTooltip(k("tooltips.placeMarker"), {
                ...
                shape: this._shape,
                workingLayer: this._layer
            }), this._setGlobalDrawMode(), this._map.eachLayer((function (t) {
        ...
        disable: function () {
            ...
            this._enabled && (this._enabled = !1, this._map.off("click", this._createMarker, this), this._hintMarker.remove(), this._map.off("mousemove", this._syncHintMarker, this), this._map.eachLayer((function (e) {
                ...
                shape: this._shape
            }), this._setGlobalDrawMode(), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !1), this.options.snappable && this._cleanupSnapping())
        },
    ...
    H.Line = H.extend({
        ...
        enable: function (t) {
            L.Util.setOptions(this, t), this.options.finishOnDoubleClick && !this.options.finishOn && (this.options.finishOn = "dblclick"), this._enabled = !0, this._layerGroup = new L.LayerGroup, this._layerGroup._pmTempLayer = !0, this._layerGroup.addTo(this._map), this._layer = L.polyline([], this.options.templineStyle), this._layer._pmTempLayer = !0, this._layerGroup.addLayer(this._layer), this._hintline = L.polyline([], this.options.hintlineStyle), this._hintline._pmTempLayer = !0, this._layerGroup.addLayer(this._hintline), this._hintMarker = L.marker(this._map.getCenter(), {
                ...
                shape: this._shape,
                workingLayer: this._layer
            }), this._setGlobalDrawMode(), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !0), this._otherSnapLayers = []
        },
        disable: function () {
        ...
        hasSelfIntersection: function () {
            return 0 < q()(this._layer.toGeoJSON(15)).features.length
        },
        ...
        _finishShape: function (t) {
            ...
            a.pm._updateHiddenPolyCircle(), this.disable(), this._map.fire("pm:create", {
                shape: this._shape,
                layer: a
            })
        },
    ...
    }), H.CircleMarker = H.Marker.extend({
        initialize: function (t) {
        ...
        enable: function (t) {
            ...
            L.Util.setOptions(this, t), this._enabled = !0, this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !0), this.options.editable ? (this._layerGroup = new L.LayerGroup, this._layerGroup._pmTempLayer = !0, this._layerGroup.addTo(this._map), this._layer = L.circleMarker([0, 0], this.options.templineStyle), this._layer._pmTempLayer = !0, this._layerGroup.addLayer(this._layer), this._centerMarker = L.marker([0, 0], {
                ...
                direction: "bottom",
                opacity: .8
            }).openTooltip()), this._map.on("mousemove", this._syncHintMarker, this), this._map.fire("pm:drawstart", {
                shape: this._shape,
                workingLayer: this._layer
            }), this._setGlobalDrawMode(), this.options.editable || this._map.eachLayer((function (t) {
                e.isRelevantMarker(t) && t.pm.enable()
            }))
        },
        disable: function () {
            var t = this;
            this._enabled && (this.options.editable ? (this._map._container.style.cursor = "", this._map.off("click", this._finishShape, this), this._map.off("click", this._placeCenterMarker, this), this._map.removeLayer(this._layerGroup)) : (this._map.off("click", this._createMarker, this), this._map.eachLayer((function (e) {
                t.isRelevantMarker(e) && e.pm.disable()
            })), this._hintMarker.remove()), this._map.off("mousemove", this._syncHintMarker, this), this._map.fire("pm:drawend", {
                shape: this._shape
        ...
        _finishShape: function (t) {
            ...
            var e = this._centerMarker.getLatLng(),
                ...
                a = L.circleMarker(e, i).addTo(this._map);
            a.pm._updateHiddenPolyCircle(), this.disable(), this._map.fire("pm:create", {
                shape: this._shape,
                layer: a
            })
    ...
    function tt(t) {
        switch (t.type) {
            ...
            case "MultiPolygon":
                var e = [];
                if (Object(Q.flattenEach)(t, (function (t) {
                        1 < $()(t) && e.push(t.geometry.coordinates)
                    })), e.length) return {
                    type: "MultiPolygon",
                    coordinates: e
                }
    ...
    H.Cut = H.Polygon.extend({
        ...
        _cut: function (t) {
            ...
            Object.keys(r).map((function (t) {
                ...
                var n = function (t, e) {
                        var r = Object(W.getGeom)(t),
                            n = Object(W.getGeom)(e),
                            i = t.properties || {};
                        if (r = tt(r), n = tt(n), !r) return null;
                        if (!n) return Object(Z.feature)(r, i);
                        var a = X.diff(r.coordinates, n.coordinates);
                        return 0 === a.length ? null : 1 === a.length ? Object(Z.polygon)(a[0], i) : Object(Z.multiPolygon)(a, i)
                    }(r.toGeoJSON(15), t.toGeoJSON(15)),
                    i = L.geoJSON(n, r.options);
                1 === i.getLayers().length && (i = function (t, e) {
                    return function (t) {
                        if (Array.isArray(t)) return t
                    }(t) || function (t, e) {
                        ...
                        if (t) {
                            ...
                            return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? et(t, e) : void 0
                        }
                    }(t, e) || function () {
                        throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                    }()
                }(i.getLayers(), 1)[0]);
                var a = i.addTo(e._map);
                a.pm.enable(e.options), a.pm.disable(), r._pmTempLayer = !0, t._pmTempLayer = !0, r.remove(), t.remove(), a.getLayers && 0 === a.getLayers().length && e._map.pm.removeLayer({
                    target: a
                }), r.fire("pm:cut", {
                    shape: e._shape,
                    layer: a,
    ...
    nt.LayerGroup = L.Class.extend({
        ...
        _initLayer: function (t) {
            var e = this;
            ["pm:edit", "pm:update", "pm:enable", "pm:disable", "pm:remove", "pm:dragstart", "pm:drag", "pm:dragend", "pm:snap", "pm:unsnap", "pm:cut", "pm:intersect", "pm:markerdragend", "pm:markerdragstart", "pm:vertexadded", "pm:vertexremoved", "pm:centerplaced"].forEach((function (r) {
        ...
        enable: function () {
            ...
            L.Util.setOptions(this, t), this._map = this._layer._map, this.enabled() || (this._enabled = !0, this._layer.fire("pm:enable", {
                layer: this._layer
            }), this.applyOptions())
        },
        enabled: function () {
        ...
        disable: function () {
            this._enabled = !1, this.disableLayerDrag(), this._layer.off("contextmenu", this._removeMarker, this), this._layer.fire("pm:disable", {
                layer: this._layer
    ...
    var lt = {
        ...
        createCache: function () {
            var t = [].concat(ot(this._markerGroup.getLayers()), ot(this.markerCache));
        ...
        applyLimitFilters: function (t) {
            var e = t.latlng,
                ...
                n = ot(this._filterClosestMarkers(r));
            this.renderLimits(n)
        },
        _filterClosestMarkers: function (t) {
            var e = ot(this.markerCache),
    ...
    nt.Line = nt.extend({
        ...
        enable: function (t) {
            L.Util.setOptions(this, t), this._map = this._layer._map, this._map && (this.enabled() || this.disable(), this._enabled = !0, this._initMarkers(), this.applyOptions(), this._layer.fire("pm:enable", {
                layer: this._layer
            }), this._layer.on("remove", this._onLayerRemove, this), this.options.allowSelfIntersection || this._layer.on("pm:vertexremoved", this._handleSelfIntersectionOnVertexRemoval, this), this.cachedColor = void 0, this.options.allowSelfIntersection || (this.cachedColor = this._layer.options.color, this.isRed = !1, this._handleLayerStyle()))
        },
        ...
        disable: function () {
            ...
            t.pm._enabled = !1, t.pm._markerGroup.clearLayers(), t.pm._markerGroup.removeFrom(this._map), t.off("mousedown"), t.off("mouseup"), this._layer.off("remove", this._onLayerRemove, this), this.options.allowSelfIntersection || this._layer.off("pm:vertexremoved", this._handleSelfIntersectionOnVertexRemoval);
            var e = t._path ? t._path : this._layer._renderer._container;
            return L.DomUtil.removeClass(e, "leaflet-pm-draggable"), this.hasSelfIntersection() && L.DomUtil.removeClass(e, "leaflet-pm-invalid"), this._layer.fire("pm:disable", {
                layer: this._layer
            }), this._layerEdited && this._layer.fire("pm:update", {
                layer: this._layer
            }), !(this._layerEdited = !1)
        ...
        _handleLayerStyle: function (t) {
            ...
            if (this.hasSelfIntersection()) {
                ...
                t ? (r.setStyle({
                    ...
                    layer: this._layer,
                    intersection: q()(this._layer.toGeoJSON(15))
                })
            } else r.setStyle({
        ...
        _createMiddleMarker: function (t, e) {
            var r = this;
            if (!t || !e) return !1;
            var n = C.calcMiddleLatLng(this._map, t.getLatLng(), e.getLatLng()),
                i = this._createMarker(n),
                a = L.divIcon({
                    className: "marker-icon marker-icon-middle"
                });
            return i.setIcon(a), t._middleMarkerNext = i, (e._middleMarkerPrev = i).on("click", (function () {
                var n = L.divIcon({
                    className: "marker-icon"
                });
        ...
        _addMarker: function (t, e, r) {
            ...
            var n = t.getLatLng(),
                ...
                s = a.index,
                l = a.parentPath,
                h = 1 < o.length ? y()(i, l) : i,
                c = 1 < o.length ? y()(this._markers, l) : this._markers;
            h.splice(s + 1, 0, n), c.splice(s + 1, 0, t), this._layer.setLatLngs(i), !0 !== this.options.hideMiddleMarkers && (this._createMiddleMarker(e, t), this._createMiddleMarker(t, r)), this._fireEdit(), this._layer.fire("pm:vertexadded", {
                layer: this._layer,
                marker: t,
        ...
        _removeMarker: function (t) {
            ...
            var r = t.target,
                ...
                s = i.parentPath;
            if (a) {
                var l, h, c = 1 < a.length ? y()(n, s) : n,
                    u = 1 < a.length ? y()(this._markers, s) : this._markers;
                if (c.splice(o, 1), this._layer.setLatLngs(n), this.isPolygon() && c.length <= 2 && c.splice(0, c.length), c.length <= 1 && (c.splice(0, c.length), this._layer.setLatLngs(n), this.disable(), this.enable(this.options)), function (t) {
                        return ! function t(e) {
                    ...
                    }(n) && this._layer.remove(), r._middleMarkerPrev && this._markerGroup.removeLayer(r._middleMarkerPrev), r._middleMarkerNext && this._markerGroup.removeLayer(r._middleMarkerNext), this._markerGroup.removeLayer(r), this.isPolygon() ? (l = (o + 1) % u.length, h = (o + (u.length - 1)) % u.length) : (h = o - 1 < 0 ? void 0 : o - 1, l = o + 1 >= u.length ? void 0 : o + 1), l !== h) {
                    var p = u[h],
                        f = u[l];
                    !0 !== this.options.hideMiddleMarkers && this._createMiddleMarker(p, f)
                }
        ...
        updatePolygonCoordsFromMarkerDrag: function (t) {
            var e = this._layer.getLatLngs(),
                ...
                a = n.index,
                o = n.parentPath;
            (1 < i.length ? y()(e, o) : e).splice(a, 1, r), this._layer.setLatLngs(e)
        },
        _getNeighborMarkers: function (t) {
            var e = this.findDeepMarkerIndex(this._markers, t),
                ...
                n = e.index,
                i = e.parentPath,
                a = 1 < r.length ? y()(this._markers, i) : this._markers,
                o = (n + 1) % a.length;
            return {
        ...
        _onMarkerDrag: function (t) {
            ...
            if (n) {
                ...
                var o = 1 < n.length ? y()(this._markers, a) : this._markers,
                    s = (i + 1) % o.length,
                ...
                if (e._middleMarkerNext) {
                    var p = C.calcMiddleLatLng(this._map, h, u);
                    e._middleMarkerNext.setLatLng(p)
                }
                if (e._middleMarkerPrev) {
                    var f = C.calcMiddleLatLng(this._map, h, c);
        ...
        _checkMarkerAllowedToDrag: function (t) {
            var e = this._getNeighborMarkers(t),
                ...
                o = at()(this._layer.toGeoJSON(15), i.toGeoJSON(15)).features.length,
    ...
    }), nt.Rectangle = nt.Polygon.extend({
        _shape: "Rectangle",
        _initMarkers: function () {
            var t = this._map,
                e = this._findCorners();
        ...
        applyOptions: function () {
            this.options.snappable ? (this._initSnappableMarkers(), this._outerMarker.on("move", this._syncHintLine, this), this._outerMarker.on("move", this._syncCircleRadius, this), this._centerMarker.on("move", this._moveCircle, this)) : this._disableSnapping()
        },
        _disableSnapping: function () {
            var t = this;
        ...
        enable: function (t) {
            var e = this;
            L.Util.setOptions(this, t), this._map = this._layer._map, this.enabled() || this.disable(), this._enabled = !0, this._initMarkers(), this.applyOptions(), this._layer.fire("pm:enable", {
                layer: this._layer
        ...
        disable: function () {
            ...
            if (!this.enabled()) return !1;
            if (t.pm._dragging) return !1;
            this._centerMarker.off("dragstart", this._fireDragStart, this), this._centerMarker.off("drag", this._fireDrag, this), this._centerMarker.off("dragend", this._fireDragEnd, this), t.pm._enabled = !1, t.pm._helperLayers.clearLayers(), t.off("mousedown"), t.off("mouseup");
            var e = t._path ? t._path : this._layer._renderer._container;
            return L.DomUtil.removeClass(e, "leaflet-pm-draggable"), this._layer.fire("pm:disable", {
                layer: this._layer
            }), this._layerEdited && this._layer.fire("pm:update", {
                layer: this._layer
            }), !(this._layerEdited = !1)
        ...
        _moveCircle: function (t) {
            ...
            var r = this._layer._radius,
                n = this._getLatLngOnCircle(e, r);
            this._outerMarker.setLatLng(n), this._syncHintLine(), this._updateHiddenPolyCircle(), this._layer.fire("pm:centerplaced", {
                layer: this._layer,
                latlng: e
            })
        },
        ...
        _updateHiddenPolyCircle: function () {
            this._hiddenPolyCircle ? this._hiddenPolyCircle.setLatLngs(C.circleToPolygon(this._layer, 200).getLatLngs()) : this._hiddenPolyCircle = C.circleToPolygon(this._layer, 200), this._hiddenPolyCircle._parentCopy || (this._hiddenPolyCircle._parentCopy = this._layer)
        }
    }), nt.CircleMarker = nt.extend({
        _shape: "CircleMarker",
        initialize: function (t) {
            this._layer = t, this._enabled = !1
        },
        ...
        enable: function () {
            ...
            L.Util.setOptions(this, t), this._map = this._layer._map, this._map && (this.enabled() || this.disable(), this.applyOptions(), this._layer.fire("pm:enable", {
                layer: this._layer
            }), this._enabled = !0, this._layer.on("pm:dragend", this._onMarkerDragEnd, this), this._updateHiddenPolyCircle())
        },
        disable: function () {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this._layer;
            return !(t.pm._dragging || (t.pm._helperLayers && t.pm._helperLayers.clearLayers(), this._map || (this._map = this._layer._map), this.options.editable ? this._map.off("move", this._syncMarkers, this) : this._map.off("move", this._updateHiddenPolyCircle, this), this.disableLayerDrag(), this.enabled() || (this._layer.fire("pm:disable", {
                layer: this._layer
            }), this._layerEdited && this._layer.fire("pm:update", {
                layer: this._layer
            }), this._layerEdited = !1), this._layer.off("contextmenu", this._removeMarker, this), t.pm._enabled = !1))
        },
        _initMarkers: function () {
            var t = this._map;
            this._helperLayers && this._helperLayers.clearLayers(), this._helperLayers = new L.LayerGroup, this._helperLayers._pmTempLayer = !0, this._helperLayers.addTo(t);
        ...
        _createCenterMarker: function (t) {
            var e = this._createMarker(t);
            return this.options.draggable ? (L.DomUtil.addClass(e._icon, "leaflet-pm-draggable"), e.on("drag", this._moveCircle, this)) : e.dragging.disable(), e
        },
        _moveCircle: function (t) {
            var e = t.latlng;
            this._layer.setLatLng(e);
        ...
        _removeMarker: function () {
            this.options.editable && this.disable(), this._layer.fire("pm:remove"), this._layer.remove(), this._layer.fire("pm:remove", {
                layer: this._layer
            }), this._map.fire("pm:remove", {
                layer: this._layer
            })
        ...
        _updateHiddenPolyCircle: function () {
            var t = this._layer._map.project(this._layer.getLatLng()),
                e = L.point(t.x + this._layer.getRadius(), t.y),
                r = this._layer.getLatLng().distanceTo(this._layer._map.unproject(e)),
                n = L.circle(this._layer.getLatLng(), this._layer.options);
            n.setRadius(r), this._hiddenPolyCircle ? this._hiddenPolyCircle.setLatLngs(C.circleToPolygon(n, 200).getLatLngs()) : this._hiddenPolyCircle = C.circleToPolygon(n, 200), this._hiddenPolyCircle._parentCopy || (this._hiddenPolyCircle._parentCopy = this._layer)
        }
    }), r(143), r(144), L.PM = L.PM || {
        version: n.a,
        Map: N,
        Toolbar: F,
        Draw: H,
